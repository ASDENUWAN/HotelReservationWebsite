...
//This condition doesn't want. because HTML form has included the required condition. 
    //if(isset($_POST["submit"])){
        ...
        //insert data
          $sql="INSERT INTO contact_us(C_id,Customer_full_name,Customer_email,Customer_country,Customer_subject,Customer_message) VALUES ('','$fullname','$email','$country','$subject','$message')";
