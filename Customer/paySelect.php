...
<!--navigation bar-->
	...
	<center>
	<div class = "paySelect">
	    <h2 id="t2">Select a Payment Method :</h2><br><br>
	    <button id = "pay" type="button" ><a href = "payment.php" class = "pay-select">Pay With Debit/Credit Card</a></button><br><br><br>
	    <button id = "pay" type="button" ><a href = "https://www.paypal.com/lk/home" class = "pay-select">Pay With Paypal</a></button><br><br> 
	</div>
	</center>
