...
<!--Header-->
	...
	<center>
		...
		<button  type="button" id="butt1" ><a id="log_changer" href="rlogin.php" class="butt-a">Log in</a></button><br>
		
		<?php
			if(isset($_SESSION["rid"])){ //already log   
				echo"<script>
...
<!--navigation bar-->
	...
	<ul type="none" class="nav">
		...
		<li class="nav-list"><a href="bookinghandle.php" class="list-a">Booking handling</a></li>
		<li class="nav-list"><a href="contact.php" class="list-a">Contact</a></li>
	</ul>
